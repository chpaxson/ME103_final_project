...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../../EECS106B_QDEC.srcs/sources_1/new/clk_wiz_0" \
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/naichenzhao/Desktop/EECS106B_Proj/FPGA/EECS106B_QDEC/EECS106B_QDEC.cache/compile_simlib/xcelium"
  fi
